"""
Django settings for ssm_project project.
...
SECRET_KEY = 'django-insecure-@atkvycm^i&vc7w!0j!or$lptam9eka(*5i_$tn=4hpwr-p5+b'
...
WSGI_APPLICATION = 'ssm_project.wsgi.application'
...
EMAIL_HOST_PASSWORD = 'gqubejajhfnvqxdi'
